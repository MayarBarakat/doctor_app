...
class UnderProcessingPage extends StatefulWidget {
  @override
  State<UnderProcessingPage> createState() => _UnderProcessingPageState();
}

class _UnderProcessingPageState extends State<UnderProcessingPage> {
  List<Trip> trips = [
    Trip(
